...
BOT_TOKEN = environ.get('BOT_TOKEN', "6737043514:AAEd3vvPwKz6xGY-QL57lgpg9jGqvhyeIoI")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Deltafilter:Deltafilter10@cluster0.hutjg8r.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "rg9532271")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001684438328')).split()]
